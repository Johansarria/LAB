...
main:
    ...
    li $t1, -2147483648       # $t1 tendrá el número mayor

    # Bucle para leer los números y encontrar el mayor
...
input_loop:
    ...
    ble $t3, $t1, next_number  # Si el número ingresado no es mayor, pasar al siguiente

    # Actualizar el mayor número
    move $t1, $t3
...
print_result:
    ...
    move $a0, $t1             # Cargar el mayor número en $a0
